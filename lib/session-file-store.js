...
module.exports = function (session) {
  ...
  FileStore.prototype.find = function ( identity, callback, idOnly = false ) {
    helpers.findSessionByIdentity( identity, this.options, callback, idOnly )
  }
  ...
  FileStore.prototype.map = function (callback) {
    helpers.map(this.options, callback);
  };
